            ...
            <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
              <div className="w-full flex flex-col justify-start items-start space-y-8">
                ...
                <div className="flex justify-start items-start flex-col space-y-2">
                  <p className="text-sm dark:text-white leading-none text-gray-800"><span className="dark:text-gray-400 text-gray-300">Brand: </span> {item?.brandname}</p>
                  <p className="text-sm dark:text-white leading-none text-gray-800"><span className="dark:text-gray-400 text-gray-300">Memory: </span> {item?.ram}</p>
                  <p className="text-sm dark:text-white leading-none text-gray-800"><span className="dark:text-gray-400 text-gray-300">Storage: </span> {item?.storage}</p>
                </div>
              </div>
      ...
      <div className="flex justify-center flex-col md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
        ...
        <div className="flex shadow-lg flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-white space-y-6">
          ...
          <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
            <div className="flex justify-between w-full">
              ...
              <p className="text-base dark:text-gray-300 leading-4 text-gray-600">{formatCurrency(subTotal())}</p>
            </div>
            <div className="flex justify-between items-center w-full">
              ...
              <p className="text-base dark:text-gray-300 leading-4 text-gray-600">-{formatCurrency((cartSubtotal * 10) / 100)} (10%)</p>
            </div>
            <div className="flex justify-between items-center w-full">
        ...
        <div className="flex shadow-lg flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-white space-y-6">
          ...
          <div className="flex justify-between items-start w-full">
            ...
            <p className="text-lg font-semibold leading-6 dark:text-white text-gray-800">{formatCurrency(150)}</p>
          </div>
